...
import { Container, Heading } from './PrivacyPolicy.styles';
...
const PrivacyPolicy = () => {
  return (
    <Container>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Kabayan Konek.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Kabayan Konek, accessible from{' '}
            <a
              href="https://www.kabayankonek.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.kabayankonek.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            Internet such as a mobile applications push notifications regarding
      ...
      <ul>
        <li>By email: contact@kabayankonek.com</li>
      </ul>
    </Container>
  );
};
